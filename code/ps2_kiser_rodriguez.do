/* 
ECON 80 - PS2: The Effects of Medicaid Expansions on Childbearing Decisions
11/4/2025
mena kiser 
ariana rodriguez
*/
...
program main 
    ...
    *** outcomes, controls, and heterogeneity variables to try 
    global outvars has_hcovany has_hinscaid has_hcovpub has_hinsemp nchild newbaby 
    global covars male age /*race*/ white black native asian other any_hispan /* marital status*/ married separated single /*own educ*/ educ_d2 educ_d3 educ_d4 educ_d5 educ_d6 
    ...
    ************** Table 2: Effects on insurance coverage and other possible effects
